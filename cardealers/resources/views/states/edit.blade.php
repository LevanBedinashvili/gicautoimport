                            ...
                            <form action="{{ route('state.update', $edit_data->id) }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select id="auction_id" name="auction_id" class="default-select form-control wide">
                                            <option value="{{ $edit_data->auction_id }}" selected>{{ $edit_data->auction->name }}</option>
                                            @forelse ($get_auctions as $auctions)
                                                <option value="{{ $auctions->id }}">{{ $auctions->name }}</option>
                                            @empty
